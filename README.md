...
## Ломаем
__Указал несуществующий образ__

Мы сломали podinfo, изменив образ на несуществующий тег. Flux перешёл в состояние ошибки, поды упали с ImagePullBackOff. После исправления образа в Git, Flux автоматически восстановил приложение, подтвердив принципы self-healing GitOps.

это должно было так выглядеть, но у меня что-то пошло не так